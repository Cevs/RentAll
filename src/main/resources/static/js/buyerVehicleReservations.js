...
$(document).ready(function () {
    ...
    $("#reservationStatusMenu .dropdown-menu a").click(function () {
        $("#reservationStatusMenu button").text($(this).text());
        statusSelected = $("#reservationStatusMenu button").text();
        getReservations();
    });
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            $.each(data, function (i, item) {
                ...
                var $card = $(
                    "<div id ='" + item.reservationId + "' class=\"card\">\n" +
                    ...
                    "                <button id='"+item.id+"' class=\"btn btn-info \" style='float:left;''>Detail</button>" +
                    "            </div>\n" +
                    "        </div>"
                )
