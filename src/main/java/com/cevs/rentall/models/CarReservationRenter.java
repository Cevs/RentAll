...
public class CarReservationRenter extends VehicleReservationRenter {
    private VehicleReservationRenter vrr;
    private int doors;
    private String color;
    private int trunkCaapcity;

    public CarReservationRenter() {
    }

    public CarReservationRenter(VehicleReservationRenter vrr){
        this.vrr = vrr;
    }
    ...
    public int getTrunkCaapcity() {
        return trunkCaapcity;
    }

    public void setTrunkCaapcity(int trunkCaapcity) {
        this.trunkCaapcity = trunkCaapcity;
    }
}
